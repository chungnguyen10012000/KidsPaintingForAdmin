...
const Products: React.FC = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="row">
        <TopCard title="TỔNG SỐ GIÁO VIÊN" text={`${numberItemsCount}`} icon="box" class="primary" />
        <TopCard title="TỐNG SỐ LỚP ĐANG DẠY" text={`${totalAmount}`} icon="warehouse" class="danger" />
        <TopCard title="TỔNG SỐ CUỐC THI" text={`${totalPrice}`} icon="box" class="success" />
      </div>
          ...
          <div className="popup-content">
            <button type="button"
              ...
              onClick={() => {
                ...
                dispatch(addNotification("Giáo viên", ` ${products.selectedProduct.name} đã bị xóa khỏi hệ thống`));
