...
const initialState: IUserState = {
    ...
    selectedUser: null,
    users: [
        { id: 1, firstName: "Nguyễn", lastName: "Chung", email: "nvlong00@gmail.com", username: 'teacher', sex: "Nam", dateOfDay: "10/01/2000", address: "Thanh Hoa", phone: "0987123456", password: '12345678aA@', userStatus: true, avatar: '' },
